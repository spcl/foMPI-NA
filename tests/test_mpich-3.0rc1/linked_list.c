...
int main(int argc, char **argv) {
    ...
    for (i = 0; i < NUM_ELEMS; i++) {
        ...
        do {
            ...
            foMPI_Win_lock(foMPI_LOCK_EXCLUSIVE, tail_ptr.rank, 0, llist_win);
            ...
            if (success) {
                ...
                foMPI_Put(&new_elem_ptr.disp, 1, MPI_AINT, tail_ptr.rank,
                ...
                do {
                    ...
                    foMPI_Get( &next_tail_ptr.disp, 1, MPI_AINT, tail_ptr.rank,
