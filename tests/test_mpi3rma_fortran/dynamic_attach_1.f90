      subroutine test_mpi3rma_dynamic_attach_1( DIM1, win, comm )
      ...
      write (filename,*) "dynamic_attach_1.f90"

      call MPI_Comm_rank( comm, rank, mpierr )
  
      allocate( base(DIM1), stat=mpierr )
      allocate( base2(DIM1), stat=mpierr )
      allocate( base3(DIM1), stat=mpierr )
  
      ! assuming an integer has a size of 4
      attach_size = DIM1*4
      ...
      end subroutine test_mpi3rma_dynamic_attach_1
