      subroutine test_mpi3rma_allocate_c_intrinisic( comm )
      ...
      integer, dimension(1) :: shape = array_size
      ...
      write (filename,*) "allocate_c_intrinisic.f90"
      ...
      end subroutine test_mpi3rma_allocate_c_intrinisic
